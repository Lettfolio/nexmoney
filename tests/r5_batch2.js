  ...
  try {
    ...
    console.log("\n— R5-4 · offer parse renders a diff and writes nothing until Apply (ca043)");
    {
      ...
      /* Tick the lender conflict as well.
         ...
         R54 — parse-offer now also reads Balance, Monthly payment, Offer date, Reversion rate,
      ...
      ok("R54 · …and the new offer readings (Monthly payment, Repayment method, Account number) are among them",
      ...
      ok("R54 · the fuller offer readings persisted (balance, monthly payment, reversion, repayment method, offer date, account + reference)",
